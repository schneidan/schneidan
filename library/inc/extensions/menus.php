...
/**
 * Top bar right menu search bar
 *
 * @since 0.1 DJS
 * @see wp_nav_menu
 */

if ( !function_exists('top_bar_search_form') ) {
	function top_bar_search_form() {
		$search_form = '<li class="divider"></li>';
		$search_form .= '<li class="has-form">';
			$search_form .= '<div class="show-search"></div>';
    		$search_form .= '<form role="search" method="get" id="searchform" action="' . home_url() . '" class="hidden-form">';
				$search_form .= '<div class="row collapse">';
					$search_form .= '<div class="large-10 small-10 columns">';
						$search_form .= '<input type="text" value="' . get_search_query() . '" name="s" id="s" placeholder="' . esc_attr__('Search', 'reactor') . '">';
					$search_form .= '</div>';
					$search_form .= '<div class="large-2 small-2 columns end">';
						$search_form .= '<input class="button prefix" type="submit" id="searchsubmit" value="">';
					$search_form .= '</div>';
				$search_form .= '</div>';
			$search_form .= '</form>';
		$search_form .= '</li>';
